import { forwardRef, useState, useEffect, cloneElement, type Ref, ReactNode, Fragment, useMemo } from 'react';
import {
  PopoverMenuProps,
  PopoverMenuItem,
...
const MenuItem = forwardRef((props: MenuItemProps, ref: Ref<HTMLDivElement>) => {
  ...
  const cls = useMemo(() => {
    return clsx('popover-menu-item', popoverMenuItemBaseCls, {
      ...
      'dark:bg-gray-700/75 bg-gray-100/75 text-gray-500!': isSubMenuItem,
    });
