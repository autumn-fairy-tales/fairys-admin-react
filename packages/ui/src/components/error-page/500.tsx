...
export const ErrorPage500 = (props: ErrorPageProps) => {
  ...
  return (
    <div className="fairys:w-full fairys:h-full fairys:flex fairys:flex-col fairys:items-center fairys:justify-center">
      <div>
        <svg width="254" height="294">
          ...
          <g fill="none" fillRule="evenodd">
            ...
            <path d="M37.19 135.59l10.553 5.983M48.665 147.884l-12.734 10.861" stroke="#FFF" strokeWidth="2"></path>
            <path
      ...
      <div className="fairys:text-xl fairys:font-medium">500</div>
      <div className="fairys:text-xl fairys:font-medium">对不起，出了点问题。</div>
